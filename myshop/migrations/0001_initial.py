    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category_slug', models.CharField(max_length=255, unique=True, verbose_name='Slug:')),
            ],
        ),
        migrations.CreateModel(
            name='Janr',
            fields=[
                ...
                ('Janr_slug', models.CharField(max_length=255, unique=True, verbose_name='Janr Slug:')),
            ],
        ),
        migrations.CreateModel(
            name='Movies',
            fields=[
                ...
                ('janr', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myshop.janr')),
            ],
        ),
        migrations.CreateModel(
            name='Comments',
            fields=[
                ...
                ('movie_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myshop.movies')),
